...
KeyVal SDL3Keyboard::translateScanCodeToKeyVal(unsigned char scan)
{
	...
	switch ((SDL_Scancode)scan) {
		...
		// Numeric keypad
		// GeneralsX @bugfix 02/08/2026 CommandMap.ini binds camera rotate/zoom/reset to
		// KEY_KP4/KP6/KP8/KP2/KP5. Without these cases the keypad fell through to KEY_NONE,
		// so those commands never reached MetaEventTranslator.
