...
# GeneralsX @refactor 26/07/2026 The ExtrasMenu overlay no longer ships a layout file. It is built
# programmatically now, so there is nothing to copy here and no stale loose .wnd left overriding the
# BIG archives.
